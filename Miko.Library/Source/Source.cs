...
public abstract class Source : IDisposable
{
    ...
    /// </summary>
    protected readonly Queue<char> lookaheadBuffer = new(MaxLookahead);
    ...
    public char Read()
    {
        ObjectDisposedException.ThrowIf(disposed, nameof(Source));
